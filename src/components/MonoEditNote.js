...
import { Form, Dropdown, Button, Radio } from "semantic-ui-react";
...
export default class MonoEditNote extends Component {
    ...
    chooseNotes = () => {
        const combo = this.state.note + this.state.octave;
        ...
        return (
            <Form onSubmit={this.chooseNotes}>
                <Dropdown
                    ...
                    onChange={(e, { value }) =>
                        this.handleChange(e, value, "note")
                    }
                />
                <Dropdown
                    ...
                    onChange={(e, { value }) =>
                        this.handleChange(e, value, "octave")
                    }
                />
                <br></br>
                <Radio
