...
export default class Auth extends Component {
    ...
    sendAuth = (name) => {
        ...
        fetch(`${BASE_URL}login`, {
            ...
            body: JSON.stringify({ name, email: Cookies.get("email") }),
        })
            .then((res) => res.json())
            .then((json) => {
    ...
    render() {
        return (
            <div className="login-wrapper">
                ...
                <div
                    className="color-beam purple"
                    style={{ animationDelay: "1s" }}
                ></div>
                <div
                    className="color-beam yellow"
                    style={{ animationDelay: "2s" }}
                ></div>
                <div
                    className="color-beam green"
                    style={{ animationDelay: "3s" }}
                ></div>
                <div
                    className="color-beam blue"
