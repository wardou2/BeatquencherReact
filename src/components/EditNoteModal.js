   ...
   return (
     <div>
       <Modal dimmer='blurring' size='mini' open={open} onClose={this.close}>
         ...
         <Modal.Actions>
            {(this.props.ins_type === 'monosynth') ? <MonoEditNote currentNote={this.props.currentNote} chooseNotes={this.props.chooseNotes}/> : <PolyEditNote currentNote={this.props.currentNote} chooseNotes={this.props.chooseNotes}/> }
         </Modal.Actions>
       </Modal>
     </div>
   )
